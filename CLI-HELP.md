...
--mlock                                 DEPRECATED in favor of `--load-mode`: mmap + force system to keep
                                        model in RAM rather than swapping or compressing
                                        (env: LLAMA_ARG_MLOCK)
...
-lm,   --load-mode MODE                 model loading mode (default: mmap)
                                        ...
                                        - mlock: mmap + force system to keep model in RAM rather than swapping
                                        or compressing
...
--server-base URL                       connect to this server instead of starting a new one, example:
                                        'http://localhost:8080' (default: none)
